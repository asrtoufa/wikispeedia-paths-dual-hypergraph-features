...
class Graph:
    ...
    def read_from_files(cls, nodes_filename: str,
        ...
        with open(nodes_filename) as f:
            print("input node file: ", nodes_filename)
            num_nodes, num_node_features = map(int, f.readline().split('\t'))
            print("the number of nodes is: ", num_nodes, "and the number of features is: ", num_node_features, "\n")
        ...
        with open(edges_filename) as f:
            print("input edge file: ", edges_filename)
            num_edges, num_edge_features = map(int, f.readline().split('\t'))
            print("the number of edges is: ", num_edges, "and the number of features is: ", num_edge_features, "\n")
